...
#pragma endregion
		...
		void RefreshDGVStaff(){
			ModuloStansa^ modulo_prueba = gcnew ModuloStansa();
			modulo_prueba->id = 3; //Pruebo con cualquier Modulo
			List<Staff^>^ listStaff = StansaManager::QueryAllStaffByModuloStansa(modulo_prueba);	
