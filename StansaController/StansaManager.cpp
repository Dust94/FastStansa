...
List<Attention^>^ StansaManager::QueryAllAttentionByModuloStansaStatus(ModuloStansa^ modulo, String^ estadoCustomer){
	return attentionDB->QueryAllByModuloStansaStatus(modulo, estadoCustomer);
}
